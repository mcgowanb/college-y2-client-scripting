...
function addEventListeners() {
    ...
    document.getElementById('link-1').addEventListener("click", moveLink, false);
    document.getElementById('change-image').addEventListener("click", changeImage, false);
    document.getElementById('img4').addEventListener("click",alterImage, false);
    document.getElementById('hgroup').addEventListener("click",make5Changes, false);
